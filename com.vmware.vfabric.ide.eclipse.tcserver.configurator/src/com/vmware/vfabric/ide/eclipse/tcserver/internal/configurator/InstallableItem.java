...
import com.vmware.vfabric.ide.eclipse.tcserver.internal.configurator.operations.AbstractInstallOperation;
import com.vmware.vfabric.ide.eclipse.tcserver.internal.configurator.operations.ChmodOperation;
import com.vmware.vfabric.ide.eclipse.tcserver.internal.configurator.operations.CopyOperation;
...
public class InstallableItem {
	...
	private static String substitute(String text, Properties properties) {
	...
	private File getSourceLocation() throws CoreException {
		...
		try {
			...
			throw new CoreException(
					new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Failed to determine install location", e));
		}
	}
