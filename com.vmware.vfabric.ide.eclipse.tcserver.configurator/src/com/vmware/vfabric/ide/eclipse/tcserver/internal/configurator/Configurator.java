...
import com.vmware.vfabric.ide.eclipse.tcserver.internal.configurator.ConfiguratorImporter.ParticipantExtensionPointReader;
...
public class Configurator {
	...
	public void executePendingRequests() {
		...
		if (configureTargets != null && configureTargets.length() > 0) {
		...
		Activator.getDefault().getPreferenceStore().setValue(Activator.PROPERTY_CONFIGURE_TARGETS,
				String.join(File.pathSeparator, newConfigureTargets));
	}
