 ...
 *******************************************************************************/
package com.vmware.vfabric.ide.eclipse.tcserver.internal.configurator.server;
...
import com.vmware.vfabric.ide.eclipse.tcserver.configurator.util.HttpUtil;
				...
				Display.getDefault().syncExec(new Runnable() {
					public void run() {
						response[0] = MessageDialog.openQuestion(
								PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), "Install Runtime",
					...
					try {
						...
						Display.getDefault().syncExec(new Runnable() {
							public void run() {
								...
								WizardDialog dialog2 = new WizardDialog(
										PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), wizard2);
						...
						Activator.log(new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Error getting license", e));
					}
				}
