...
/**
 * Command for starting a (stopped or not running) server module/application
 *
 * @author Alex Boyko
 *
 */
public class StartModuleCommand extends AbstractModuleCommand {

	public StartModuleCommand(TcServerBehaviour serverBehaviour, IModule[] module) {
	...
	protected Object doOperation(MBeanServerConnection beanServerConnection) throws IOException, JMException,
		...
		return beanServerConnection.invoke(getName(), "startApplication", operationArguments,
